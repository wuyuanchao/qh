...
public interface OrderInfoMapper extends CommonCountMapper, CommonDeleteMapper, CommonUpdateMapper {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(orderId, orderSn, trackingNumber, trackingNumber2, quantity, price, sku, productId, country, countryCode, province, city, address, zipCode, shippingName, phoneNumber, orderTime, payTime, shippingTime, shippingMethod, status, gmtCreated, gmtModify);
