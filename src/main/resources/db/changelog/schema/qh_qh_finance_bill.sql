...
--
-- Table structure for table `qh_finance_bill`
--

DROP TABLE IF EXISTS `qh_finance_bill`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `qh_finance_bill` (
  `rec_id` int NOT NULL AUTO_INCREMENT,
  `bill_no` varchar(45) NOT NULL DEFAULT '' COMMENT '账单编号',
