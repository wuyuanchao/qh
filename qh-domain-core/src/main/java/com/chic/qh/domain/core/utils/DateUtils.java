package com.chic.qh.domain.core.utils;
...
// 获取当天的开始时间
	...
	public static String getDateByTimeAndZone(Integer time, String formatStr, String timeZone) {
		try {
			formatStr = !StringUtils.isEmpty(formatStr) ? DATE_STR : formatStr;
	...
	public static String getGapTime(String num) {
		if (num == null) {
			return num;
		}
		long time = Long.valueOf(num);
